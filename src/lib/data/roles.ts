...
export const ROLE_NAV: Record<Role, string[]> = {
  admin: [
    "dashboard", "payroll", "employees", "offboarding", "overtime", "commissions", "increments",
  ...
  dept_head: ["dashboard", "payroll", "employees", "overtime", "commissions", "expenses", "tasks", "reports"],
